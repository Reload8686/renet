...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/opt/python/.11/bin',
 'BINLIBDEST': '/opt/python/.11/lib/python3.11',
 'BLDLIBRARY': '-L. -lpython3.11',
 'BLDSHARED': 'gcc -shared -Wl,-rpath=/opt/python/.11/lib,--disable-new-dtags',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Wextra -Wno-unused-parameter '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-Wl,-rpath=/opt/python/.11/lib,--disable-new-dtags',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/opt/python/.11' '--enable-shared' '--enable-ipv6' "
                "'LDFLAGS=-Wl,-rpath=/opt/python/.11/lib,--disable-new-dtags'",
 'CONFINCLUDEDIR': '/opt/python/.11/include',
 'CONFINCLUDEPY': '/opt/python/.11/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/reload/remod/cpython-3.11.0b3/coverage.info',
 'COVERAGE_REPORT': '/home/reload/remod/cpython-3.11.0b3/lcov-report',
 ...
 'DESTDIRS': '/opt/python/.11 /opt/python/.11/lib '
             '/opt/python/.11/lib/python3.11 '
             '/opt/python/.11/lib/python3.11/lib-dynload',
 'DESTLIB': '/opt/python/.11/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/opt/python/.11/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/opt/python/.11/include /opt/python/.11/include '
                   '/opt/python/.11/include/python3.11 '
                   '/opt/python/.11/include/python3.11',
 'INCLUDEDIR': '/opt/python/.11/include',
 'INCLUDEPY': '/opt/python/.11/include/python3.11',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -shared -Wl,-rpath=/opt/python/.11/lib,--disable-new-dtags',
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/opt/python/.11/lib/python3.11',
 'LIBDIR': '/opt/python/.11/lib',
 ...
 'LIBEXPAT_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -std=c11 '
                    ...
                    '-fPIC -fPIC -I./Modules/expat',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBMPDEC_A': 'Modules/_decimal/libmpdec/libmpdec.a',
 'LIBMPDEC_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -std=c11 '
                    '-Wextra -Wno-unused-parameter '
                    '-Wno-missing-field-initializers '
                    '-Werror=implicit-function-declaration '
                    '-fvisibility=hidden  -I./Include/internal -I. -I./Include '
                    '-fPIC -fPIC -I./Modules/_decimal/libmpdec -DCONFIG_64=1 '
                    '-DANSI=1 -DHAVE_UINT128_T=1',
 'LIBMPDEC_HEADERS': '\\',
 'LIBMPDEC_OBJS': '\\',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/python/.11/lib/pkgconfig',
 'LIBPL': '/opt/python/.11/lib/python3.11/config-3.11-aarch64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/python/.11/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/opt/python/.11/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 ...
 'PY_CORE_LDFLAGS': '-Wl,-rpath=/opt/python/.11/lib,--disable-new-dtags',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-Wl,-rpath=/opt/python/.11/lib,--disable-new-dtags',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-Wl,-rpath=/opt/python/.11/lib,--disable-new-dtags',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/home/reload/remod/cpython-3.11.0b3',
 'SCRIPTDIR': '/opt/python/.11/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 'SHLIBS': '-ldl',
 'SHLIB_SUFFIX': '.so',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/home/reload/remod/cpython-3.11.0b3 ./python '
               '-E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/home/reload/remod/cpython-3.11.0b3 ./python '
               '-E ./Tools/scripts/run_tests.py',
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': '"./opt/python/.11"',
 'WASM_STDLIB': '""./opt/python/.11"/local/lib/python3.11/os.py"',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/home/reload/remod/cpython-3.11.0b3',
 'abs_srcdir': '/home/reload/remod/cpython-3.11.0b3',
 'datarootdir': '/opt/python/.11/share',
 'exec_prefix': '/opt/python/.11',
